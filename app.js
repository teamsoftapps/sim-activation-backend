...
import updateE911address from './src/routes/updateE911address.js';
import userRoutes from './src/routes/userRoutes.js';
import activatewithAddressRoutes from './src/newRoutes/ActivateSubscriberWithAddress.js';
import DeActivateSubscriber from './src/newRoutes/DeActivateSubscriber.js';
import UpdateE911address from './src/newRoutes/UpdateE911address.js';
const swaggerSpec = swaggerJsdoc(swaggerOptions);
app.use(express.json());
