...
// // import CancelDeviceLocation from './src/routes/Common/CancelDeviceLocation.js';
// import QueryDevice from './src/routes/Common/QueryDevice.js';
// import QueryUnlockStatus from './src/routes/Common/QueryUnlockStatus.js';
...
// app.use('/CancelDeviceLocation',CancelDeviceLocation);
// app.use('/QueryDevice',QueryDevice);
// app.use("/QuerySim",QueryeSIMProfileStatus);
...
app.use('/bulkDeactivateSubscriber', bulkDeactivateSubscriber);
app.use('/bulkReactivateSubscriber', bulkReactivateSubscriber);
app.use('/GetActivePlanSOC', GetActivePlanSOC);
app.use('/bulkUpdateE911Address', bulkUpdateE911);
app.use('/QueryPortInStatus', QueryPortInStatus);
app.use('/CheckPortInEligibility', CheckPortInEligibility);
app.use('/QueryNetwork', QueryNetwork);
app.use('/CheckNetworkCoverage', CheckNetworkCoverage);
